...
from .views import registrar_comicion, asignar_docente_comicion, registrar_evalucion_formal, registrar_tribunal
...
urlpatterns = [
    ...
    path('registrar_evaluacion_formal/', registrar_evalucion_formal, name='registrar_evaluacion_formal'),
    ...
    path('registrar_evaluacion_ft/', registrar_evaluacion_tf, name='registrar_evaluacion_tf'),
