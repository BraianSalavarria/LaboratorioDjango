...
from .models import IntegrantesPTF,MovimientosPTF #,ProyectoTrabajoFinal,
...
class RegistrarProyectoTrabajoFinal(ModelForm):
    ...
    class Meta:
        ...
        fields = ('titulo','fechaPresentacion','descripcion','archivosAdjuntos','director','coDirector'
                  ,'ascesor') # ,'NroResolucionTribunal' pos 3
